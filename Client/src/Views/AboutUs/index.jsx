    ...
    <section className="About_Us-Wave">
      <div className="AboutUs-div-top d-flex flex-column">
        ...
        <h5 className="About_Us-Text">
          ...
          managing household chores. Our verified and experienced services professional base ensures
          timely delivery of services at competitive rates, while assuring customers of safety and
          security.
